...
MEDIUM_POOL = [
    ...
    "cinematic photorealistic advertising photography",
"mixed-media editorial portrait with newspaper textures and paint splashes",
"surreal aerial composite photography",
"cinematic fantasy landscape photography",
"high-detail dark fantasy character art",
"soft-focus cinematic portrait photography",
"icy fantasy realism with crystalline textures",
"surreal conceptual fine-art photography",
"vivid commercial fashion photography",
"neon cyberpunk digital art",
"dreamlike magical realism",
"ethereal pastel fantasy photography",
"bioluminescent forest fantasy art",
"dark gothic cinematic fantasy",
"retro pop-art studio photography",
"polished broadcast editorial photography",
"ink-and-watercolor scientific illustration",
"bright colorful stage photography",
"high-key travel portrait photography",
...
SETTING_POOL = [
    ...
    "serene cloudscape above the clouds",
"vintage editorial collage backdrop",
"dark emerald pond filled with floating lotus leaves",
"snowy wilderness beneath vivid aurora lights",
"sun-dappled enchanted forest",
"misty urban interior seen through reflective glass",
"frozen birch forest under aurora glow",
"dark studio with a monumental cracked glass enclosure",
"sunny boulevard lined with palm trees and star-shaped pavement",
"minimal futuristic studio with warm amber illumination",
"moonlit botanical garden with glowing flowers",
"romantic spring garden surrounded by flowering branches",
"ancient woodland with moss-covered trees and mushrooms",
"gothic stone cathedral exterior under storm clouds",
"bright pastel studio with a retro television set",
"modern broadcast studio overlooking a city skyline",
"aged parchment backdrop with hand-drawn scientific motifs",
"concert stage filled with colorful theatrical lights",
"grand stone city square with ornate architecture",
"dramatic crimson studio backdrop",
    "a gothic fantasy throne hall with a ghostly antlered stag spirit looming behind",
"an opulent ancient Chinese imperial palace hall with glowing lanterns",
"a moonlit Japanese shrine courtyard with a torii gate and cherry blossoms",
"a sunken underwater ruin with ancient columns and coral",
...
CAMERA_POOL = [
    ...
    "wide horizontal composition with soft golden backlighting",
"centered head-and-shoulders portrait with layered graphic framing",
"perfectly symmetrical overhead composition",
"vertical portrait with dramatic upward perspective",
"shallow depth of field with sunbeams filtering through foliage",
"extreme close-up through reflective glass with soft bokeh",
"tight portrait framing with cool atmospheric backlight",
"centered full-body composition inside a translucent enclosure",
"eye-level full-body street portrait with deep perspective",
"medium portrait with centered subject and rim lighting",
"vertical environmental portrait with oversized moon in the background",
"soft frontal portrait framed by blossoms and drifting petals",
"three-quarter portrait with warm woodland backlighting",
"low-angle heroic composition with expansive wingspan",
"studio fashion portrait with clean pastel backdrop",
"full-body studio framing with large windows and city bokeh",
"three-quarter illustrated portrait with decorative orbital linework",
"dynamic low-angle stage shot with colorful lens flare",
"centered street portrait with symmetrical architectural lines",
"split-scale beauty composition combining close-up and full-body views",
...
PROP_POOL = [
    ...
    "a folded paper map",
    "a battered notebook",
    "open book and takeaway coffee cup",
"paint-splattered editorial textures",
"wooden canoe surrounded by lily pads",
"fur-lined winter hood",
"antler crown woven with leaves and vines",
"rain-speckled glass surface",
"frost-covered floral crown",
"large cracked translucent glass sphere",
...
"broadcast microphone and studio console",
"golden orbital diagrams",
"handheld stage microphone",
"small bouquet of red roses",
"scattered white pigeons",
    "a reusable metal lunch container",
    "a vintage desk fan",
    "an ornate ceremonial staff or scepter",
"a traditional folding fan",
"a sheathed katana at the hip",
...
WARDROBE_POOL = [
    ...
    "navy knit top with relaxed olive trousers",
"structured cobalt blazer over a cream blouse",
"flowing lime-green wrap dress",
"black insulated winter parka with fur-trimmed hood",
"organic forest-inspired textured costume",
"earth-toned layered outdoor clothing",
"icy fantasy attire with frost-covered textures",
"simple gray fitted t-shirt with dark trousers",
"red fitted top with black leather jacket and dark pants",
"black futuristic hooded jacket with glowing circuit patterns",
"soft pink long-sleeve top with a patterned headscarf and dark denim",
"translucent pink floral fantasy gown",
"natural bark-textured woodland costume",
"ornate dark medieval armor",
"white sleeveless crop top with pleated pink skirt",
"silky beige blouse with fitted black mini skirt",
"minimal crew-neck shirt for an illustrated portrait",
"bright yellow ruffled stage costume",
"flowing black modest abaya and head covering",
"elegant black evening gown with layered pearl jewelry",
    ...
    "a dark feathered royal gown with a jeweled crown and ornate cloak",
"an elaborate pearl-draped historical Chinese dancer's costume with flowing sleeves",
"a floral kimono paired with samurai armor accents",
"a flowing pearl-embellished bridal-style gown made for underwater movement",
...
SPECIAL_PATTERN_POOL = [
    {
        ...
        {
        "label": "gothic poolside skeleton resort editorial",
        "setting": "a sunlit gothic stone courtyard pool surrounded by arches, statues, black candles and palm trees",
        "wardrobe": "black lace bikini with gold hardware, wet hair and relaxed high-fashion resort silhouette",
        "action": "reclining on a carved stone lounge chair while adjusting sunglasses and looking toward the camera",
        "camera": "35mm fashion-lifestyle frame with bright midday light and clear turquoise water",
        "twist": "skeleton butler and floating skeleton on an inflatable create playful dark-humor contrast",
        "color": "black, turquoise, warm stone, gold accents and soft skin tones",
        "texture": "wet skin, carved stone, pool water and delicate lace",
        "prop": "SPF bottle, skull cup and black towel with gold embroidery",
        "gaze": "camera",
    },
    {
        "label": "candlelit sheer nightgown balcony portrait",
        "setting": "a warm Parisian-style bedroom at night with tall windows, sheer curtains and city lights outside",
        "wardrobe": "transparent cream sheer nightgown with thin straps, soft romantic silhouette",
        "action": "standing with back slightly turned while looking over the shoulder toward the camera",
        "camera": "50mm intimate portrait with warm candlelight and soft window glow",
        "twist": "multiple candles and city lights create layered warm bokeh behind the subject",
        "color": "warm amber, soft cream, deep brown and golden highlights",
        "texture": "sheer organza, flowing fabric movement and natural skin glow",
        "prop": "none",
        "gaze": "camera",
    },
    {
        "label": "playful cat-ear bedroom cosplay portrait",
        "setting": "a cozy sunlit bedroom with posters on the wall, plants and soft natural window light",
        "wardrobe": "cream knit cardigan worn open over delicate lace lingerie, cat ears and matching tail",
        "action": "lying on the bed propped on elbows while sticking tongue out playfully toward the camera",
        "camera": "50mm candid lifestyle close-up with soft daylight and shallow depth of field",
        "twist": "real cat lying nearby and the subject’s own cat-ear and tail create a cute double-theme",
        "color": "cream, soft beige, warm sunlight and muted bedroom tones",
        "texture": "chunky knit, delicate lace, soft bedding and natural freckled skin",
        "prop": "bell choker necklace",
        "gaze": "camera",
    },
    {
        "label": "sunny kitchen morning shirt portrait",
        "setting": "a bright French-style kitchen with wooden counter, plants, fridge magnets and soft morning light",
        "wardrobe": "oversized open white linen shirt worn with minimal underwear, casual intimate silhouette",
        "action": "leaning against the kitchen counter while drinking from a ceramic mug and looking at the camera",
        "camera": "35mm lifestyle portrait with natural window light and soft shadows",
        "twist": "morning breakfast details (bread, jam, coffee maker) create a lived-in, authentic atmosphere",
        "color": "white, warm wood, soft green and bright daylight",
        "texture": "crumpled linen, wooden surfaces, ceramic and natural skin texture",
        "prop": "ceramic mug with handwritten text",
        "gaze": "camera",
    },
    {
        "label": "steam-filled traditional sauna portrait",
        "setting": "a wooden Japanese-style sauna with soft steam, wooden benches and warm diffused light",
        "wardrobe": "completely nude, natural and intimate silhouette",
        "action": "sitting on the wooden bench with arms crossed over the knees, looking downward thoughtfully",
        "camera": "50mm intimate environmental portrait with soft steam haze and warm practical light",
        "twist": "steam and soft backlight create a gentle atmospheric veil around the subject",
        "color": "warm wood tones, soft greenish light and natural skin",
        "texture": "wet skin, polished wood and soft steam particles",
        "prop": "wooden water bucket nearby",
        "gaze": "down",
    },
    {
        "label": "watercolor floral paint-drip portrait",
        "setting": "a soft abstract background of watercolor paint drips and floral illustrations",
        "wardrobe": "wet sheer white lace top that appears to dissolve into paint, artistic silhouette",
        "action": "standing facing the camera with wet hair and paint dripping down the body",
        "camera": "85mm beauty portrait with soft even lighting and painterly texture overlay",
        "twist": "the subject’s body and clothing literally blend into watercolor paint and floral strokes",
        "color": "soft beige, muted purple, dusty pink, watercolor blue and warm skin tones",
        "texture": "wet paint drips, sheer lace and realistic wet skin",
        "prop": "none",
        "gaze": "camera",
    },
    {
        "label": "rajasthani palace yoga pose editorial",
        "setting": "an ornate pink sandstone palace courtyard with arches, chandeliers and soft golden sunlight",
        "wardrobe": "intricate pink and gold embroidered lehenga-style crop top and skirt with heavy jewelry",
        "action": "lying on the ornate rug in a graceful yoga backbend pose with eyes closed",
        "camera": "35mm fashion-editorial frame with warm directional light and shallow depth of field",
        "twist": "the dramatic arched architecture and golden hour light create a regal cinematic backdrop",
        "color": "dusty rose, antique gold, soft pink and warm sandstone",
        "texture": "embroidered silk, heavy jewelry, marble floor and soft skin",
        "prop": "large statement earrings and necklace",
        "gaze": "closed / up",
    },
    {
        "label": "bioluminescent flower metro surreal portrait",
        "setting": "a subway train car completely overgrown with glowing neon flowers, vines and bioluminescent plants",
        "wardrobe": "oversized cream cardigan over a short plaid skirt, casual everyday silhouette",
        "action": "standing in the aisle holding the overhead rail while looking downward thoughtfully",
        "camera": "35mm cinematic wide frame with neon practical lights and wet reflective floor",
        "twist": "every passenger and surface is covered in living glowing flowers creating a surreal living train",
        "color": "neon orange, magenta, soft green, cream and dark metro tones",
        "texture": "glowing petals, wet floor, knit cardigan and natural skin",
        "prop": "none",
        "gaze": "down",
    },
    {
        "label": "tropical waterfall white bikini portrait",
        "setting": "a powerful tropical waterfall cascading into turquoise water surrounded by palms and red flowers",
        "wardrobe": "simple white string bikini, wet and clinging, natural beach-goddess silhouette",
        "action": "standing under the falling water with hands gently touching the face and eyes closed in bliss",
        "camera": "50mm fashion frame with strong backlight, water spray and a soft rainbow",
        "twist": "a bright rainbow arcs through the mist behind the subject",
        "color": "turquoise, pure white, deep green, red tropical flowers and golden sunlight",
        "texture": "heavy water spray, wet skin, mossy rocks and flowing hair",
        "prop": "none",
        "gaze": "up / closed",
    },
    {
        "label": "rainy night bedroom lingerie portrait",
        "setting": "a dimly lit bedroom at night with rain streaking down the window and soft city lights outside",
        "wardrobe": "soft pink satin and lace lingerie set, intimate and relaxed silhouette",
        "action": "lying on the bed propped on one elbow while looking toward the camera with a soft expression",
        "camera": "50mm intimate lifestyle portrait with warm practical lamp light and cool window glow",
        "twist": "rain on the window creates soft bokeh city lights that contrast with the warm interior",
        "color": "dusty rose, warm amber, cool blue window light and soft neutrals",
        "texture": "satin, delicate lace, soft bedding and natural skin",
        "prop": "none",
        "gaze": "camera",
    },
    {
        "label": "glowing fiber-optic dress fantasy portrait",
        "setting": "a dark abstract space filled with swirling golden and blue light trails",
        "wardrobe": "ethereal dress made of glowing golden and blue fiber-optic strands that wrap around the body",
        "action": "standing with one hand in the hair while looking directly at the camera",
        "camera": "85mm beauty portrait with dramatic rim lighting from the glowing fibers",
        "twist": "the dress itself is living light, creating continuous swirling trails around the subject",
        "color": "warm gold, electric blue, soft skin tones and deep black background",
        "texture": "glowing light strands, wet-looking skin and soft hair movement",
        "prop": "none",
        "gaze": "camera",
    },
    {
        "label": "moody concrete apartment cigarette portrait",
        "setting": "a modern concrete loft apartment with strong window blinds creating dramatic striped light",
        "wardrobe": "simple black slip dress with thin straps, minimal and sensual silhouette",
        "action": "kneeling on a dark sofa while holding a cigarette high above the head and exhaling smoke upward",
        "camera": "50mm cinematic portrait with hard directional light and deep shadows",
        "twist": "strong striped shadows from the blinds cut dramatically across the body and wall",
        "color": "charcoal, black, warm skin highlights and soft gray concrete",
        "texture": "smooth fabric, concrete walls, rising smoke and natural skin",
        "prop": "cigarette and ashtray on the table",
        "gaze": "up",
    },
    {
        "label": "sunset beach ivory gown standing portrait",
        "setting": "a soft pastel beach at sunset with gentle waves, white pebbles and tall pampas grass",
        "wardrobe": "elaborate ivory structured gown with layered sheer fabric and high slit, ethereal silhouette",
        "action": "standing in the shallow water while holding the flowing fabric and looking over the shoulder",
        "camera": "35mm fashion-editorial frame with warm golden backlight and soft ocean reflections",
        "twist": "the long train of the gown spreads across the wet sand creating elegant movement",
        "color": "soft peach, ivory, warm gold and pale sky",
        "texture": "layered sheer fabric, wet sand, white pebbles and flowing hair",
        "prop": "none",
        "gaze": "left",
    },
    {
        "label": "sunset beach ivory gown lying portrait",
        "setting": "the same soft pastel beach at golden hour with white pebbles and gentle waves",
        "wardrobe": "the same elaborate ivory structured gown with layered sheer fabric, now fully spread on the sand",
        "action": "lying on the sand with one arm above the head and looking softly toward the camera",
        "camera": "35mm fashion frame from a slightly elevated angle with warm sunset light",
        "twist": "the gown fabric radiates outward across the pebbles like a soft sculpture",
        "color": "warm peach, ivory, soft gold and pale sand",
        "texture": "sheer layered fabric, smooth white pebbles and natural skin",
        "prop": "none",
        "gaze": "camera",
    },
    {
        "label": "artist studio pencil portrait with sketchbook",
        "setting": "a bright classical artist studio with canvases, plaster busts and soft natural window light",
        "wardrobe": "nude from the waist up, natural and classical life-model silhouette",
        "action": "sitting while looking at the camera as an artist’s hand draws her portrait in a sketchbook in the foreground",
        "camera": "50mm dual-focus composition showing both the real subject and the drawing",
        "twist": "the finished pencil portrait in the open sketchbook perfectly mirrors the real person",
        "color": "soft neutrals, warm skin tones, paper white and muted studio tones",
        "texture": "pencil on paper, natural skin and soft fabric in the background",
        "prop": "open sketchbook and pencil",
        "gaze": "camera",
    },
    {
        "label": "celestial guanyin lotus goddess portrait",
        "setting": "a heavenly landscape of clouds, distant mountains and soft sunrise light above a lotus pond",
        "wardrobe": "ornate white and soft pink embroidered celestial robes with golden jewelry and a large crystal halo",
        "action": "seated in lotus position on a giant glowing lotus while holding a small vase and making a gentle mudra",
        "camera": "35mm epic fantasy frame with soft volumetric light and sparkling details",
        "twist": "the giant crystal halo and floating lotus petals create a sacred, luminous atmosphere",
        "color": "pearl white, soft pink, gold, crystal clear and warm sunrise tones",
        "texture": "embroidered silk, crystal, pearl and soft glowing light",
        "prop": "small white vase with a green sprig",
        "gaze": "down / serene",
    },
    {
        "label": "tang dynasty night palace stairs portrait",
        "setting": "an ornate traditional Chinese palace at night with red pillars, golden lanterns and stone stairs",
        "wardrobe": "strapless cream and gold embroidered Tang-style gown with sheer sleeves and heavy jewelry",
        "action": "sitting on the stone steps with one leg extended while looking directly at the camera",
        "camera": "50mm cinematic portrait with warm lantern light and soft night atmosphere",
        "twist": "the long flowing train of the gown cascades down the stairs creating elegant movement",
        "color": "cream, antique gold, deep red and warm lantern amber",
        "texture": "embroidered silk, sheer fabric, polished stone and metallic jewelry",
        "prop": "elaborate golden headdress and ankle bracelet",
        "gaze": "camera",
    },
        {
        "label": "industrial concrete urban denim street style",
        "setting": "a rough textured industrial concrete wall with weathered metal structures and urban background",
        "wardrobe": "light washed denim overalls paired with a chic black lace top underneath and chunky white sneakers, no logos",
        "action": "leaning against the concrete wall with one arm raised behind the head and a confident relaxed posture",
        "camera": "full-body vertical street fashion shot with natural lighting, sharp focus and crisp details",
        "twist": "harsh architectural shadows and raw concrete textures contrast sharply with the soft feminine styling",
        "color": "industrial gray, light denim blue, stark black, and clean white",
        "texture": "rough concrete, distressed denim, delicate lace, and smooth natural skin",
        "prop": "a modern minimalist watch on the wrist",
        "gaze": "camera",
    },
    {
        "label": "ethereal giant white flower fantasy portrait",
        "setting": "a dreamlike outdoor fantasy landscape surrounded by massive sculptural white paper petals and bright sky",
        "wardrobe": "an elegant white cutout swimsuit accented with delicate metallic ring details and fluid translucent silk, no branding",
        "action": "posing mid-shot inside a giant sculptural white lotus flower with graceful posture",
        "camera": "high-fashion editorial photography with soft dreamy backlighting and crystal-clear subject sharpness",
        "twist": "huge translucent sculptural petals create a surreal organic cocoon framing the subject",
        "color": "pure white, soft sky blue, metallic gold accents, and pearl tones",
        "texture": "silky smooth fabric, paper-like sculptural petals, shimmering water reflections, and flawless skin",
        "prop": "sculptural flower petals framing the body",
        "gaze": "camera",
    },
    {
        "label": "flowing white silk ethereal sky dance",
        "setting": "a high-altitude reflective glass floor under a clear bright blue summer sky with soft clouds",
        "wardrobe": "a fitted white cutout outfit paired with high-heeled strappy sandals and long swirling silk drapes, no logos",
        "action": "full-body motion pose stretching one arm overhead while holding swirling silk ribbons that float around the body",
        "camera": "wide-angle fashion action shot capturing flying drapery and bright outdoor daylight reflections",
        "twist": "dramatic flowing white drapery swirls in mid-air creating elegant curved movement lines around the subject",
        "color": "clear sky blue, pure white, reflective silver, and warm skin tones",
        "texture": "lightweight floating silk, reflective glass, delicate sandal leather, and crisp skin texture",
        "prop": "long flowing translucent white silk fabric",
        "gaze": "camera",
    },
    {
        "label": "high-fashion avant-garde paper leaf throne",
        "setting": "a grandiose white classical hall interior with an elaborate throne made of layered paper leaves and feathers",
        "wardrobe": "an ornate avant-garde white corset gown made of intricate paper leaves, lace, and feather textures, no branding",
        "action": "seated gracefully on a massive white leaf throne with legs crossed and a royal expression",
        "camera": "medium shot editorial portrait with soft high-key studio lighting and high-detail contrast",
        "twist": "an over-the-top avant-garde throne and gown entirely crafted from white paper leaves and feathers",
        "color": "pure white, ivory, soft shadow gray, and natural porcelain skin",
        "texture": "crisp paper edges, delicate feather plumage, fine lace, and soft skin",
        "prop": "ornate paper leaf throne background structure",
        "gaze": "camera",
    },
    {
        "label": "vibrant japanese summer festival water splash",
        "setting": "a lively traditional Japanese summer festival courtyard with wooden shrine architecture and festive banners",
        "wardrobe": "traditional Japanese festival attire featuring a inscribed tenugui headband, woven rope waist belt, and festive resort wear, no logos",
        "action": "celebrating joyfully hoisted on shoulders with arms raised high amidst flying water splashes and cheering crowd",
        "camera": "dynamic action capture with high shutter speed freezing water droplets and bright daylight illumination",
        "twist": "flying water droplets catch the sunlight mid-air, creating a burst of chaotic joyful energy",
        "color": "vibrant indigo blue, bright white, natural wood brown, and sunlit gold",
        "texture": "splashing water, woven straw rope, cotton fabric, and sun-kissed skin",
        "prop": "a small wooden festival bowl and festival banners",
        "gaze": "upper-right",
    },
    {
        "label": "luxury poolside resort back pose relaxation",
        "setting": "the edge of a turquoise resort swimming pool with sunlit water ripples and poolside stone tiling",
        "wardrobe": "a minimal white bikini bottom with a sheer lace kimono cover-up draping off the shoulders, no logos",
        "action": "sitting on the pool edge with legs dipping in the water, looking back over the shoulder toward the camera",
        "camera": "medium shot back-angle resort fashion photograph with warm sunlight and soft background bokeh",
        "twist": "a captivating back-angle perspective framed by delicate sheer lace sleeves and shimmering pool water",
        "color": "pool water turquoise, stone beige, soft lace ivory, and warm sun highlights",
        "texture": "sheer lace weave, wet skin, rippling water, and woven straw hat",
        "prop": "a wide-brimmed straw hat resting on the poolside deck",
        "gaze": "back",
    },
    {
        "label": "sunlit resort stone deck overhead sunbathing",
        "setting": "a warm sunlit stone poolside patio next to clear blue rippling water with harsh geometric shadows",
        "wardrobe": "a textured white bikini set paired with a light lace robe draped around the arms, no branding",
        "action": "lying back casually on the stone deck in a relaxed sunbathing posture with eyes gently closed or gazing softly",
        "camera": "top-down high angle overhead portrait with warm directional sunlight casting soft shadow slanting lines",
        "twist": "dramatic high-angle top-down perspective with diagonal shadow lines cutting across the warm stone floor",
        "color": "sun-bleached stone gray, clear turquoise water, soft cream white, and golden sunlight",
        "texture": "rough travertine stone, textured swimwear fabric, sheer lace, and sunlit skin",
        "prop": "a large straw sunhat resting near the head",
        "gaze": "up",
    },
        {
        "label": "indoor resort swimming pool back view posture",
        "setting": "a spacious indoor luxury resort swimming pool with large floor-to-ceiling glass windows and natural daylight",
        "wardrobe": "a shimmering dark metallic blue string bikini with delicate tie closures, no logos",
        "action": "wading in the clear pool water with a back-three-quarter pose, smiling gently back over the shoulder",
        "camera": "medium shot portrait with clear water reflections, soft natural lighting, and shallow depth of field",
        "twist": "glistening wet skin and gentle water caustics creating a fresh indoor resort ambiance",
        "color": "deep ocean blue, clear turquoise water, soft beige stone, and warm skin tones",
        "texture": "metallic bikini fabric, rippling water surface, smooth damp skin, and polished pool tiles",
        "prop": "swimming pool edge tiled steps",
        "gaze": "back",
    },
    {
        "label": "cozy sunlit bedroom morning lingerie style",
        "setting": "a bright minimalist bedroom with soft white bedding, wooden furniture, and light filtering through sheer curtains",
        "wardrobe": "an unbuttoned light blue vertical-striped shirt worn open over delicate white lace lingerie, no branding",
        "action": "standing casually beside a neatly made bed with a relaxed full-body posture and gentle expression",
        "camera": "full-body indoor lifestyle portrait with soft diffused natural light from large side windows",
        "twist": "over-sized open striped shirt layering casually over delicate lingerie for a relaxed morning mood",
        "color": "soft sky blue, crisp white, natural wood brown, and pale ivory",
        "texture": "light cotton shirting, delicate lace weave, fluffy bed linen, and polished wooden flooring",
        "prop": "wooden vanity desk and mirror in background",
        "gaze": "camera",
    },
    {
        "label": "modern gym strength training exercise pose",
        "setting": "a sleek modern fitness center featuring weight racks, metal bars, and mirrored walls with industrial lighting",
        "wardrobe": "a white cropped tank top paired with grey striped athletic shorts and padded workout gloves, no logos",
        "action": "leaning forward over a barbell squat rack while performing workout prep with focused posture",
        "camera": "medium shot fitness photography with sharp focus, realistic gym lighting, and detailed specular highlights",
        "twist": "intense workout pose framed by industrial steel gym equipment and ambient indoor lighting",
        "color": "stark white, charcoal gray, steel silver, and warm natural skin",
        "texture": "stretchy cotton jersey, knurled metal bar, padded leather gloves, and smooth flooring",
        "prop": "steel barbell rack and weight plates",
        "gaze": "downward",
    },
    {
        "label": "sunlit luxury indoor pool edge pose",
        "setting": "the stone edge of an indoor luxury hotel swimming pool with floor-to-ceiling glass windows and city view",
        "wardrobe": "a metallic dark navy blue bikini set with side-tie bottoms, no logos",
        "action": "sitting on the poolside stone deck with legs casually bent, leaning forward with a gentle smile",
        "camera": "eye-level medium shot portrait with bright ambient daylight and crystal-clear pool water background",
        "twist": "glimmering metallic swimwear fabric reflecting direct sunlight against cool turquoise water",
        "color": "shimmering navy blue, bright turquoise, neutral stone gray, and natural sunlit skin",
        "texture": "metallic textured fabric, smooth pool deck stone, wet skin, and clear water",
        "prop": "poolside stone coping edge",
        "gaze": "camera",
    },
    {
        "label": "minimalist indoor pool deck relaxed sitting pose",
        "setting": "a serene minimalist indoor pool lounge with neutral stone walls, large glass windows, and quiet water",
        "wardrobe": "a soft sage green string bikini set with thin halter straps, no branding",
        "action": "sitting cross-legged directly on the smooth stone floor near the pool with a calm posture",
        "camera": "full-body front portrait with soft muted studio-style indoor daylight and clean composition",
        "twist": "minimalist muted green tones blending seamlessly with neutral architectural stone background",
        "color": "sage green, warm beige stone, soft gray, and natural porcelain skin",
        "texture": "matte bikini fabric, smooth concrete floor, clear pool water, and soft hair strands",
        "prop": "indoor pool edge and stone wall",
        "gaze": "camera",
    },
    {
        "label": "cozy vintage bedroom plush toy aesthetic",
        "setting": "a warm vintage-style bedroom with a lace-draped nightstand lamp and soft white quilted bedding",
        "wardrobe": "a delicate white camisole top paired with soft pink ruffle shorts and off-shoulder sleeves, no logos",
        "action": "reclining comfortably on a soft bed while hugging a fluffy beige plush rabbit toy",
        "camera": "soft-focus intimate indoor portrait with warm ambient lamp light and gentle pastel grading",
        "twist": "nostalgic vintage bedroom decor combined with cozy pastel nightwear and a plush toy",
        "color": "creamy white, dusty rose pink, soft beige, and warm golden lamp glow",
        "texture": "fluffy plush fur, soft cotton knit, ruffled lace, and quilted fabric",
        "prop": "a plush stuffed rabbit toy and vintage bedside lamp",
        "gaze": "camera",
    },
        {
        "label": "minimal concrete studio crop-top portrait",
        "setting": "a plain concrete studio wall with soft even lighting and no distractions",
        "wardrobe": "beige cropped t-shirt with simple text print and matching side-tie bikini bottoms, clean minimal silhouette",
        "action": "standing facing the camera with one hand raised behind the head in a relaxed pose",
        "camera": "50mm clean fashion portrait with soft studio light and neutral background",
        "twist": "the extremely simple concrete backdrop makes the outfit and pose the only focus",
        "color": "beige, soft gray concrete, natural skin tones",
        "texture": "cotton t-shirt, smooth skin, matte concrete wall",
        "prop": "none",
        "gaze": "camera",
    },
    {
        "label": "luxury sports-car night interior portrait",
        "setting": "the dark luxurious interior of a red sports car in an underground parking garage at night",
        "wardrobe": "black sheer lace lingerie set with thin straps, elegant and sensual silhouette",
        "action": "leaning across the center console with chin resting on hand, looking softly at the camera",
        "camera": "35mm intimate car-interior portrait with warm practical lights and soft shadows",
        "twist": "the red car exterior and black leather interior create a rich color contrast around the subject",
        "color": "black lace, deep red, warm amber interior light, soft skin",
        "texture": "sheer lace, leather seats, polished car surfaces",
        "prop": "delicate necklace and bracelet",
        "gaze": "camera",
    },
    {
        "label": "tactical military cosplay studio portrait",
        "setting": "an indoor tactical gear room with military crates, maps and industrial lighting",
        "wardrobe": "camouflage bikini top and tactical cargo pants with full combat gear, helmet and gloves",
        "action": "standing confidently while holding a large rifle across the body and looking at the camera",
        "camera": "50mm strong fashion-action portrait with hard side light and sharp detail",
        "twist": "the contrast between heavy tactical gear and revealing top creates a bold visual tension",
        "color": "camouflage greens and browns, black gear, concrete gray",
        "texture": "fabric webbing, metal weapons, matte plastic helmet",
        "prop": "tactical rifle and knee pads",
        "gaze": "camera",
    },
    {
        "label": "gothic lolita outdoor event portrait",
        "setting": "a sunny outdoor anime convention or festival with crowds and banners in the background",
        "wardrobe": "elaborate white and purple gothic lolita dress with heavy ruffles, ribbons and headpiece",
        "action": "standing close to the camera with a soft smile while looking directly at the viewer",
        "camera": "85mm beauty close-up with bright natural daylight and soft background bokeh",
        "twist": "the highly detailed frilly costume stands out sharply against the busy outdoor event background",
        "color": "white, soft purple, black hair, warm sunlight",
        "texture": "layers of ruffles, lace, ribbons and smooth skin",
        "prop": "decorative choker and hair clips",
        "gaze": "camera",
    },
    {
        "label": "elegant hotel hallway mini-dress portrait",
        "setting": "a stylish hotel or boutique hallway with warm wall lights, framed art and polished floors",
        "wardrobe": "tight beige ruched mini dress with thin straps and asymmetrical hem, elegant evening silhouette",
        "action": "leaning lightly against the wall while holding a small handbag and looking back over the shoulder",
        "camera": "50mm fashion-editorial full-body shot with warm practical lighting",
        "twist": "the soft hallway lights create elegant highlights along the body and dress texture",
        "color": "warm beige, soft gold, cream walls, polished floor reflections",
        "texture": "ruched fabric, smooth skin, glossy floor",
        "prop": "small chain-strap handbag and clear heels",
        "gaze": "over shoulder / camera",
    },
    {
        "label": "luxury villa floral ballgown portrait",
        "setting": "a bright tropical luxury villa terrace with outdoor sofa, palm trees and ocean view in the background",
        "wardrobe": "structured cream and blue floral print ballgown with corset bodice and full skirt",
        "action": "sitting on the outdoor sofa while looking to the side with a calm expression",
        "camera": "35mm environmental fashion portrait with soft natural daylight",
        "twist": "the large flowing skirt spreads dramatically across the sofa creating strong volume",
        "color": "cream, soft blue floral, warm sunlight, tropical green",
        "texture": "structured fabric, soft cushions, natural skin",
        "prop": "none",
        "gaze": "left",
    },
    {
        "label": "intimate bedroom messy-hair portrait",
        "setting": "a softly lit bedroom with rumpled sheets and muted natural window light",
        "wardrobe": "light blue floral short pajama dress with deep neckline, casual intimate silhouette",
        "action": "sitting on the bed with wind-blown hair partially covering the face while looking at the camera",
        "camera": "50mm intimate close-up with soft natural light and shallow depth of field",
        "twist": "the messy hair across the face creates a spontaneous, unposed feeling",
        "color": "soft blue, warm skin tones, muted bedroom neutrals",
        "texture": "light cotton fabric, soft bedding, natural skin",
        "prop": "delicate necklace",
        "gaze": "camera",
    },
    {
        "label": "cute bedroom selfie fishnet portrait",
        "setting": "a colorful modern bedroom at night with LED strip lights, string lights and city view through the window",
        "wardrobe": "white semi-sheer fishnet crop top and matching bottoms with a loose open cardigan",
        "action": "taking a high-angle selfie while smiling brightly at the camera",
        "camera": "wide-angle selfie-style shot with colorful practical LED lighting",
        "twist": "the colorful LED lights and plush bedroom create a playful, youthful atmosphere",
        "color": "white, soft pink, blue and purple LED glow",
        "texture": "fishnet mesh, soft bedding, warm skin",
        "prop": "none",
        "gaze": "camera",
    },
    {
        "label": "outdoor onsen hot-spring portrait",
        "setting": "a natural outdoor Japanese onsen surrounded by rocks, bamboo and green forest",
        "wardrobe": "completely nude, natural and relaxed silhouette in the water",
        "action": "sitting in the clear hot spring water while looking at the camera with a gentle smile",
        "camera": "50mm environmental portrait with soft daylight and steam",
        "twist": "gentle steam rises from the water creating a soft atmospheric veil",
        "color": "clear turquoise water, green forest, natural stone, soft skin",
        "texture": "wet skin, smooth rocks, gentle water ripples",
        "prop": "none",
        "gaze": "camera",
    },
    {
        "label": "traditional japanese room back-view portrait",
        "setting": "a bright traditional Japanese tatami room with shoji screens and soft natural light",
        "wardrobe": "oversized gray off-shoulder knit sweater and plaid mini skirt with thin thong",
        "action": "looking back over the shoulder toward the camera while slightly lifting the skirt",
        "camera": "50mm intimate portrait with warm window light and clean background",
        "twist": "the soft natural light from the shoji screens creates gentle highlights on the skin",
        "color": "gray knit, brown plaid, warm tatami, soft skin tones",
        "texture": "chunky knit sweater, soft fabric, tatami mat",
        "prop": "none",
        "gaze": "over shoulder / camera",
    },
    {
        "label": "anime convention dancer cosplay portrait",
        "setting": "a busy indoor anime convention hall with posters and crowds in the background",
        "wardrobe": "elaborate pink and gold fantasy dancer costume with jewels, sheer sleeves and ornate details",
        "action": "standing and holding a large decorative fan while smiling at the camera",
        "camera": "50mm beauty portrait with bright convention lighting and soft background blur",
        "twist": "the highly detailed costume and fan create strong visual richness against the busy event background",
        "color": "hot pink, gold, white, turquoise jewels",
        "texture": "sheer fabric, metallic embroidery, jewelry details",
        "prop": "large ornate folding fan and multiple bracelets",
        "gaze": "camera",
    },
    {
        "label": "autumn window soft light portrait",
        "setting": "an old stone window frame with autumn maple leaves glowing in soft backlight",
        "wardrobe": "sheer translucent white fabric draped loosely around the body, ethereal silhouette",
        "action": "leaning on the window sill while looking softly toward the camera",
        "camera": "85mm beauty portrait with strong golden backlight and soft leaf bokeh",
        "twist": "the autumn leaves and warm backlight create a dreamy, painterly atmosphere",
        "color": "warm gold, soft orange, translucent white, natural skin",
        "texture": "sheer fabric, old wood, soft leaves",
        "prop": "none",
        "gaze": "camera",
    },
    {
        "label": "pink satin bedroom lingerie portrait",
        "setting": "a soft pink bedroom with matching pink sheets and pillows in gentle daylight",
        "wardrobe": "light pink satin camisole and matching side-tie panties with small bows",
        "action": "lying on the bed with one arm raised above the head and smiling at the camera",
        "camera": "50mm intimate lifestyle portrait with soft natural light",
        "twist": "the monochromatic pink environment creates a soft, cohesive color mood",
        "color": "soft pink, warm skin tones, light neutrals",
        "texture": "satin fabric, soft bedding, smooth skin",
        "prop": "none",
        "gaze": "camera",
    },
    {
        "label": "blue hoodie bedroom book portrait",
        "setting": "a simple bedroom with white sheets and soft indoor lighting",
        "wardrobe": "cropped blue hoodie worn with nothing underneath, casual intimate silhouette",
        "action": "sitting on the bed with legs open and an open book placed in front, looking at the camera",
        "camera": "50mm intimate portrait with soft even lighting",
        "twist": "the open book creates a quiet, everyday contrast with the revealing outfit",
        "color": "bright blue, white sheets, natural skin",
        "texture": "cotton hoodie, paper pages, soft bedding",
        "prop": "open book",
        "gaze": "camera",
    },
        {
        "label": "sunny outdoor stairs black polka-dot bikini portrait",
        "setting": "outdoor wooden stairs beside a white building with decorative concrete blocks and green plants in bright sunlight",
        "wardrobe": "black polka-dot string bikini with thin straps and side ties, clean summer silhouette",
        "action": "sitting on the stairs with one leg bent and the other extended, looking slightly to the side",
        "camera": "50mm fashion portrait with strong natural sunlight and clean shadows",
        "twist": "the hard midday light creates sharp body highlights against the dark wooden stairs",
        "color": "black, white polka dots, warm wood, bright green plants, natural skin",
        "texture": "smooth bikini fabric, weathered wood, concrete blocks",
        "prop": "small hoop earring",
        "gaze": "left",
    },
    {
        "label": "forest stream monstera leaf nude portrait",
        "setting": "a rocky forest stream with clear flowing water and large natural boulders surrounded by dense greenery",
        "wardrobe": "completely nude, natural silhouette partially covered by a large green monstera leaf",
        "action": "lying on a large wet rock while holding the monstera leaf across the body and looking at the camera",
        "camera": "50mm environmental portrait with soft natural daylight and gentle water reflections",
        "twist": "the oversized monstera leaf acts as the only covering, creating a strong natural and artistic composition",
        "color": "deep green leaf, cool gray rocks, clear water, natural skin tones",
        "texture": "wet skin, glossy leaf surface, rough wet rocks, flowing water",
        "prop": "large monstera leaf",
        "gaze": "camera",
    },
    {
        "label": "black harness bathroom portrait",
        "setting": "a modern marble bathroom with a freestanding bathtub and large green plants",
        "wardrobe": "black leather body harness with metal rings and nipple covers, bold fetish silhouette",
        "action": "sitting on the marble floor leaning against the bathtub while looking at the camera",
        "camera": "50mm fashion-editorial portrait with clean bathroom lighting",
        "twist": "the hard marble surfaces contrast with the soft skin and structured harness",
        "color": "black leather, white marble, deep green plants",
        "texture": "leather straps, metal hardware, smooth marble",
        "prop": "none",
        "gaze": "camera",
    },
    {
        "label": "ocean-view high-rise white lingerie portrait",
        "setting": "a bright high-rise bedroom with floor-to-ceiling windows overlooking a tropical beach and ocean",
        "wardrobe": "white lace bra and matching thong, clean and elegant silhouette",
        "action": "sitting on the bed with back to the camera and arms raised, looking out toward the ocean",
        "camera": "35mm environmental portrait with strong natural window light",
        "twist": "the vast ocean and city view create a luxurious open backdrop behind the subject",
        "color": "white lace, bright blue ocean, soft sky, natural skin",
        "texture": "delicate lace, white bedding, glass windows",
        "prop": "none",
        "gaze": "away / window",
    },
    {
        "label": "sheer bodysuit indoor casual portrait",
        "setting": "a minimal modern apartment with line-art wall prints and soft natural light",
        "wardrobe": "dark sheer bodysuit with small rhinestone details, worn with gray sweatpants pulled down",
        "action": "standing while pulling the waistband of the sweatpants and looking downward",
        "camera": "50mm fashion portrait with soft indoor lighting",
        "twist": "the contrast between the sheer glamorous bodysuit and casual sweatpants creates an interesting mix",
        "color": "dark sheer brown, gray, soft white walls",
        "texture": "sheer mesh, rhinestones, cotton sweatpants",
        "prop": "none",
        "gaze": "down",
    },
    {
        "label": "black leather beach bikini portrait",
        "setting": "a bright sunny beach with clear blue water and distant houses",
        "wardrobe": "structured black leather-look bikini with metal rings and thin choker",
        "action": "standing on the sand facing the camera with one hand touching the hair",
        "camera": "50mm fashion beach portrait with strong natural sunlight",
        "twist": "the shiny black material contrasts sharply with the bright sand and blue ocean",
        "color": "black, bright sand, turquoise water, clear sky",
        "texture": "leather-like material, metal hardware, natural skin",
        "prop": "thin black choker",
        "gaze": "camera",
    },
    {
        "label": "sunlit patio red bottoms portrait",
        "setting": "a modern outdoor patio with large glass doors and bright midday sunlight",
        "wardrobe": "bright red bottoms only, completely topless, bold and minimal silhouette",
        "action": "sitting on the tiled floor with knees drawn up and arms supporting the body, looking at the camera",
        "camera": "35mm low-angle fashion portrait with strong sunlight and clean shadows",
        "twist": "the hard sunlight creates sharp body highlights and a strong graphic composition",
        "color": "bright red, warm skin tones, gray tiles, blue sky reflections",
        "texture": "smooth skin, hard tile floor, glass reflections",
        "prop": "thin bracelet",
        "gaze": "camera",
    },
    {
        "label": "pink shirt mirror selfie portrait",
        "setting": "a simple bright bedroom with white bedding and soft natural window light",
        "wardrobe": "open light-pink button-up shirt worn with white lace panties, casual intimate silhouette",
        "action": "taking a mirror selfie while holding a phone and looking at the camera",
        "camera": "mirror selfie style with natural daylight and soft shadows",
        "twist": "the open shirt and casual bedroom setting create a spontaneous private-moment feeling",
        "color": "soft pink, white lace, warm daylight, white bedding",
        "texture": "cotton shirt, delicate lace, soft bedding",
        "prop": "smartphone",
        "gaze": "camera",
    },
    {
        "label": "rustic wooden kitchen cooking prep style",
        "setting": "a charming rustic wooden kitchen interior with stone countertops, wooden cabinets, and fresh vegetables",
        "wardrobe": "a grey gingham check apron tied over a simple white halter top, no logos",
        "action": "leaning over a wooden countertop while reaching behind head to tie hair, standing behind fresh salad ingredients",
        "camera": "medium shot domestic lifestyle photo with warm natural daylight streaming through a kitchen window",
        "twist": "candid home-cooking scene framed by warm wooden textures and fresh colorful produce",
        "color": "gingham grey and white, natural wood tone, vibrant tomato red, and lettuce green",
        "texture": "woven apron fabric, solid wooden countertop, smooth tomato skin, and stainless steel bowl",
        "prop": "wooden cutting board, knife, fresh tomatoes, lettuce, and metal bowl",
        "gaze": "camera",
    },
    {
        "label": "sunny outdoor laundry day domestic vibe",
        "setting": "a bright sunlit backyard patio with clotheslines hanging fresh laundry under green trees",
        "wardrobe": "a grey checkered apron dress worn over a white halter top, casual domestic attire, no branding",
        "action": "leaning over a plastic laundry tub while hand-washing white garments under full sunlight",
        "camera": "medium outdoor lifestyle shot capturing bright sunlight, soft shadows, and natural greenery",
        "twist": "authentic outdoor housework atmosphere with hanging laundry catching bright sun rays",
        "color": "sun-bleached white, checkered grey, natural leaf green, and sunlit wood",
        "texture": "wet cotton fabric, plastic washbasin water, checkered weave, and wooden post grain",
        "prop": "plastic washbasin with water, clotheslines, and wooden laundry basket",
        "gaze": "camera",
    },
    {
        "label": "cinematic rainy night urban street fashion",
        "setting": "a rain-slicked luxury city street at night surrounded by tall glass skyscrapers and glowing city lights",
        "wardrobe": "a dramatic deep red silk slip dress with a high thigh slit, paired with black chunky leather boots, no logos",
        "action": "striding forward confidently through falling rain along the wet glossy sidewalk",
        "camera": "full-body cinematic fashion portrait with sharp foreground focus and sparkling wet reflection bokeh",
        "twist": "glamourous wet red silk dress contrasting with rugged black boots on a rain-soaked city avenue",
        "color": "deep crimson red, glossy wet black, amber streetlights, and cool night reflection",
        "texture": "wet clinging silk, glossy leather, rain-drenched pavement, and water droplets",
        "prop": "wet city sidewalk with blurred umbrellas in background",
        "gaze": "forward",
    },
    {
        "label": "luxury bathroom mirror selfie in bathrobe",
        "setting": "a high-end marble bathroom interior with warm ambient vanity lighting and large mirrors",
        "wardrobe": "a plush white waffle-weave bathrobe with dark piping details, open slightly at the chest, no branding",
        "action": "holding a modern smartphone to take a mirror selfie portrait while standing in front of the vanity",
        "camera": "first-person mirror selfie angle with soft warm indoor lighting and natural skin tones",
        "twist": "casual yet luxurious spa bathrobe look framed by high-end marble bathroom architecture",
        "color": "crisp white, warm beige marble, charcoal trim, and soft vanity glow",
        "texture": "plush waffle towel fabric, polished marble tiles, smooth glass mirror, and neat hair updos",
        "prop": "modern smartphone used for mirror selfie",
        "gaze": "mirror",
    },
    {
        "label": "cozy indoor onsen spa steamy selfie",
        "setting": "a tranquil traditional indoor Japanese hot spring spa with dark stone walls and a warm glowing lantern",
        "wardrobe": "a soft white textured bath towel wrapped comfortably around the body with wet damp styling, no logos",
        "action": "holding the camera in a first-person selfie angle while sitting beside a steaming stone hot spring pool",
        "camera": "intimate smartphone-style selfie perspective with warm ambient lighting, steam haze, and close-up clarity",
        "twist": "soft steam rising from the hot spring water creates a warm atmospheric blur in the background",
        "color": "warm amber, dark stone gray, soft cream white, and natural skin tones",
        "texture": "fluffy towel fabric, wet strands of hair, smooth damp skin, and textured dark stone",
        "prop": "a small wooden hot spring bucket and glowing lantern",
        "gaze": "camera",
    },
    {
        "label": "cozy indoor wooden room relaxing loungewear",
        "setting": "a warm, sun-lit wooden room interior with large windows and minimalist wooden furniture",
        "wardrobe": "soft grey minimalist lingerie set paired with matching grey thigh-high stockings, comfortable and elegant, no branding",
        "action": "relaxing comfortably in a vintage wooden armchair with legs extended and a gentle calm expression",
        "camera": "soft indoor lifestyle portrait with natural window daylight and gentle shadows",
        "twist": "warm natural window light casts soft highlights across the wooden interior and fabric textures",
        "color": "warm natural wood brown, soft grey, ivory white, and daylight glow",
        "texture": "smooth cotton fabric, polished wood grain, knit hosiery, and natural skin detail",
        "prop": "a vintage wooden armchair",
        "gaze": "camera",
    },
    {
        "label": "casual outdoor park pathway summer selfie",
        "setting": "a green public park pathway lined with trees, grass lawns, and distant benches under an overcast sky",
        "wardrobe": "a casual white sleeveless top pulled up slightly to reveal a light blue bikini top, paired with distressed denim shorts, no logos",
        "action": "taking a casual smartphone selfie while standing on a park walkway, smiling at the camera",
        "camera": "natural handheld selfie angle with wide-angle perspective and outdoor ambient lighting",
        "twist": "natural park environment with distant greenery provides an authentic casual everyday vlog aesthetic",
        "color": "natural leaf green, asphalt gray, soft denim blue, and clean white",
        "texture": "distressed denim, soft cotton, gravel pathway, and realistic outdoor skin texture",
        "prop": "smartphone used for taking the selfie",
        "gaze": "camera",
    },
    {
        "label": "moonlit celestial silver goddess portrait",
        "setting": "a floating marble pavilion high above the clouds with a giant full moon and distant floating temples",
        "wardrobe": "strapless silver and white embroidered gown with sheer sleeves and crystal jewelry",
        "action": "sitting on the marble railing with one leg extended while looking to the side",
        "camera": "35mm epic fantasy frame with cool moonlight and soft cloud atmosphere",
        "twist": "the giant moon and cascading waterfalls create a dreamlike celestial backdrop",
        "color": "silver, cool white, soft blue moonlight and pale gray",
        "texture": "embroidered sheer fabric, marble, crystal and soft hair",
        "prop": "crescent moon headdress and ankle chain",
        "gaze": "right",
    },
    {
        "label": "dark imperial throne room night portrait",
        "setting": "a grand dark imperial hall with black and gold pillars, red banners and countless candles at night",
        "wardrobe": "strapless black and deep red embroidered gown with gold patterns and heavy jewelry",
        "action": "sitting on the dark stone stairs with one leg extended while looking intensely at the camera",
        "camera": "50mm cinematic portrait with dramatic candlelight and deep shadows",
        "twist": "the long dark train of the gown spreads down the stairs among scattered red petals",
        "color": "black, deep red, antique gold and warm candlelight",
        "texture": "heavy embroidered fabric, polished dark stone and metallic jewelry",
        "prop": "elaborate dark crown and ankle bracelet",
        "gaze": "camera",
    },
    {
        "label": "fire and ice elemental fairy portrait",
        "setting": "a dramatic cosmic space split between roaring fire and sparkling ice crystals",
        "wardrobe": "organic dress made of ice crystals, dried leaves and twigs, with translucent fairy wings",
        "action": "leaning forward with one arm extended toward the camera, wet skin glistening",
        "camera": "50mm dynamic fantasy portrait with strong dual lighting (fire and ice)",
        "twist": "one side of the frame burns with fire while the other sparkles with ice and rainbow light",
        "color": "fiery orange, ice blue, silver, deep red and soft skin tones",
        "texture": "ice crystals, dried organic matter, wet skin and translucent wings",
        "prop": "none",
        "gaze": "camera",
    },
    {
...
def call_openrouter(
    ...
    for model_id in models_to_try:
        ...
        while keys_tried_for_this_model < min(MAX_KEYS_PER_MODEL, len(key_rotator)):
