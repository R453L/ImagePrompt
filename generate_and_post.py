...
Do NOT use JSON. Respond in EXACTLY this plain-text format, with each
marker on its own line, nothing before ===HOOK=== and nothing after the
last field:
...
Do NOT use JSON. Respond in EXACTLY this plain-text format:
