...
THEME_POOL = [
    ...
    "multi-pose contact-sheet / grid collage (3x3 or 6-panel) of the same person",
    "split composition: one half photoreal, other half hand-drawn ink/line-art of the same pose",
    "bold typography editorial poster (magazine-style layout, halftone dots, generic barcode, no real brand names)",
    "3D collectible figurine / toy-in-packaging transformation (a top current viral trend)",
    "retro decade transformation (e.g. 1980s/1990s film photo aesthetic, family-album or street-life style)",
    "miniature-world / tilt-shift surreal scale illusion",
    "golden-hour cinematic lifestyle portrait in a cozy apartment/balcony setting",
    "fine-art graphite pencil sketch portrait, intentionally unfinished/museum-study style",
    "natural lo-fi 'imperfect by design' candid realism (deliberately not overly polished/plastic-looking)",
    "motivational poster with hand-drawn doodles, arrows and short affirmations around the subject",
]
...
Optional loose spark for theme/style (use only if genuinely useful,
reinterpret freely, or ignore completely and invent something entirely
different — this is not a category to stay inside):
- theme spark: {theme}
...
{recent_block}
5. It must NOT name or depict any real celebrity, public figure, or real
   trademarked brand/logo/franchise — reject if any real name/brand
   appears (generic/fictional equivalents are fine).
6. The CANDIDATE CAPTION must sound like a real person casually wrote
